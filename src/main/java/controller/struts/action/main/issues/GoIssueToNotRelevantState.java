...
public class GoIssueToNotRelevantState extends FormProviderHandlingExceptionsBaseAction {

    protected static final Logger LOG = LogManager.getLogger(GoIssueToNotRelevantState.class);
    ...
    protected String doExecute() throws Exception {
        ...
        issue.goToNotRelevantStateAndSave(causeOfTransition);
