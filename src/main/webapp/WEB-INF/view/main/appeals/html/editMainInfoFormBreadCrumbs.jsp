...
<s:i18n name="controller.struts.action.main.package">
    ...
    <s:url var="appealManagementUrl" namespace="/" action="appeal-management" escapeAmp="false">
        <s:param name="locale" value="%{#request.locale}"/>
        <s:param name="appealId" value="%{appeal.id}"/>
    </s:url>
    ...
    <li class="breadcrumb-item"><s:a href="%{#appealManagementUrl}"><s:text name="appealTitle"/> № <s:property value="appeal.id"/></s:a></li>
    <li class="breadcrumb-item"><s:text name="editAppealTitle"/></li>
</s:i18n>
</ol>
