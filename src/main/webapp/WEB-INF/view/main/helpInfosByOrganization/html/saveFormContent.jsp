...
<div class="row">
    <div class="col-sm-12">
        <s:form action="save-helpinfo-by-organization" theme="bootstrap" name="saveForm" id="saveForm">
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <strong><s:text name="organization"/>:</strong> <s:property value="organization.name"/>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <s:textarea name="helpInfoByOrganization.text" id="text"
                                         key="helpInfoText"/>
                        </div>
                    </div>
                    <s:hidden name="helpInfoByOrganization.id.issueTypeId" value="%{issueTypeId}"/>
                    <s:hidden name="helpInfoByOrganization.id.organizationId" value="%{organizationId}"/>
