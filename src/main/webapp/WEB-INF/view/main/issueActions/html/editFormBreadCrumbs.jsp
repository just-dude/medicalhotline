...
<s:i18n name="controller.struts.action.main.package">
    ...
    <li class="breadcrumb-item"><s:a href="%{#issueActionManagementUrl}"><s:text name="managementIssueAction"/></s:a></li>
    <li class="breadcrumb-item"><s:text name="editIssueActionTitle"/></li>
</s:i18n>
</ol>
