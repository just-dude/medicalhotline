...
<ol class="breadcrumb">
    ...
    <s:url var="issueCategoriesUrl" namespace="/" action="issuecategories-management">
        <s:param name="locale" value="%{#request.locale}"/>
    </s:url>
    ...
    <li class="breadcrumb-item"><s:a href="%{#issueCategoriesUrl}"><s:text name="issueCategoriesManagementTitle"/></s:a></li>
    <li class="breadcrumb-item"><s:text name="issueTypesManagementTitle"/></li>
</ol>