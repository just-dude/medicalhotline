...
<s:i18n name="controller.struts.action.main.package">
    ...
    <shiro:hasPermission name="appeal:view:*:*">
        ...
        <li class="breadcrumb-item"><s:a href="%{#appealManagementUrl}"><s:text name="appealTitle"/>  № <s:property value="issue.appeal.id"/></s:a></li>
    </shiro:hasPermission>
    <li class="breadcrumb-item"><s:text name="issueTitle"/></li>
</s:i18n>
</ol>
