...
<div class="row">
    <div class="col-sm-12">
        <s:form action="edit-organization" theme="bootstrap" name="editForm" id="editForm">
            <div class="card">
                <div class="card-header">
                    <strong><s:text name="editOrganization"/></strong>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <s:select list="%{findAllOrganizationTypes()}" key="organizationType"
                                      name="organization.type" id="type" required="true" value="%{organization.type}"/>
                        </div>
                    </div>

                    <s:hidden name="organization.id" id="id"/>
